...
Before attempting this assignment, make sure to read [Lesson 6](../../../../lessons/06). Submit this assignment to [Gradescope](TODO) by **Wednesday, November 15th at 11:59PM**. Post questions with the assignment on Ed.
...
1. Download [`lec02.ipynb`]() and place it in the repository. (Don't change anything about the notebook. Yes, this this the notebook used for Lecture 2 in DSC 10 this quarter – the point is to simulate a real-world problem!)
...
1.  Partner A should open `README.md`. It'll look something like the following, just with different names and a different commit hash.
    ```
