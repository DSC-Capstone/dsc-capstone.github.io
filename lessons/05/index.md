...
All of us value many different things. For instance, in addition to valuing academic success, you might also value being a good friend. Of course, it might not feel like much of a “cost” to spend time with your friends, but that decision nonetheless reflects your priorities. As this example shows, values are not necessarily self-centered. I can value being a member of a health community, or value my child’s health, or many other values that are primarily understood in terms of someone else’s success. What makes these count as my values is that they matter to me, and I will act in ways to try to advance them.
